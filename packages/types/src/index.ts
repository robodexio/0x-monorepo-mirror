...
export interface RoboDexAssetData {
    assetProxyId: string;
    tokenAddress: string;
    side: BigNumber;
    pnl: BigNumber;
...
export type SingleAssetData = ERC20AssetData | ERC721AssetData | RoboDexAssetData;
...
export enum RevertReason {
    ...
    RoboDexInsufficientBalance = 'ROBODEX_INSUFFICIENT_BALANCE',
    RoboDexInsufficientAllowance = 'ROBODEX_INSUFFICIENT_ALLOWANCE',
